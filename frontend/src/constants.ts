...
export const PRINT_AREA_FRONT = { x: 165, y: 175, width: 173, height: 220 };
export const PRINT_AREA_BACK = { x: 165, y: 175, width: 173, height: 220 };
...
// ── Realism Engine Defaults ──
export const DEFAULT_SHADOW_INTENSITY = 0.7;
